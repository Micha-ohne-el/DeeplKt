...
[![CI status badge](https://img.shields.io/github/actions/workflow/status/Micha-ohne-el/DeeplKt/deployment.yaml?label=CD)](https://github.com/Micha-ohne-el/DeeplKt/actions/workflows/deployment.yaml)
